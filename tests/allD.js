...
let tot=0,bad=0;
for(const f of ['ui2','raw','tap','swipe','perf','pack','swrec','admin','pwa','dbl','edge','exp','xls','sheet','branch','branchtr','branch2','hub','walk','inv','plan','warehouse2','yearfilter','swpu5']){
  let out='';
